...
<div class="flex-container">
  ...
  <div>
		<div>
			...
			<div>
				<p class="p">En idealista utilizamos cookies con el objetivo de prestar un mejor servicio y proporcionarte una mejor experiencia en tu navegaci&oacute;n. Queremos informarte de manera clara y precisa sobre las cookies que utilizamos, detallando a continuaci&oacute;n, qu&eacute; es una cookie, para qu&eacute; sirve, qu&eacute; tipos de cookies utilizamos, cu&aacute;les son sus finalidades y c&oacute;mo puedes configurarlas o deshabilitarlas si as&iacute; lo deseas.</p>
			</div>
		</div>
		<div>
			<h1>&iquest;Qu&eacute; son las cookies?</h1>
			<div>
				<p class="p">Una "cookie" es un peque&ntilde;o archivo que se almacena en el ordenador del usuario, tablet, smartphone o cualquier otro dispositivo con informaci&oacute;n sobre la navegaci&oacute;n.

Las cookies nos ayudan a mejorar la calidad de nuestra web.

Las cookies son esenciales para el funcionamiento de Internet, aportando innumerables ventajas, facilit&aacute;ndote la navegaci&oacute;n y usabilidad de nuestra web.En ning&uacute;n caso las cookies podr&iacute;an da&ntilde;ar tu equipo. Por contra, el que est&eacute;n activas nos ayuda a conocer el rendimiento de la p&aacute;gina web, qu&eacute; debemos modificar y los problemas que pueden surgir.</p>
			</div>
		</div>
		<div>
			<h1>C&oacute;mo obtenemos tu consentimiento para instalar cookies</h1>
			<div>
				<p class="p">Al acceder al sitio web por primera vez recibir&aacute;s un aviso acerca del uso de cookies. En esta primera capa, se te informar&aacute; sobre el tipo de cookies que utilizamos, las finalidades para las cuales las utilizamos, y se te proporcionar&aacute; un enlace a esta Pol&iacute;tica de Cookies, donde puedes encontrar m&aacute;s informaci&oacute;n detallada. Si contin&uacute;as navegando, estar&aacute;s dando tu consentimiento para que instalemos las cookies conforme a lo descrito en esta pol&iacute;ti</p>
			</div>
		</div>
	</div>
  </div>
